  ...
  return (
    <>
      <div className="flex gap-3 mb-5 max-[640px]:flex-col">
        ...
        <link href="/catalogue" className="flex-1 py-4 border border-boza-black bg-boza-cream text-boza-black font-bold text-sm uppercase tracking-wide cursor-pointer transition-all duration-300 no-underline inline-block text-center hover:bg-boza-cream-alt">
