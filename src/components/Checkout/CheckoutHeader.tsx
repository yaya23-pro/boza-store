...
export default function CheckoutHeader() {
  ...
  return (
    <header className="bg-boza-cream border-b border-boza-cream-alt py-[18px] px-10 flex items-center justify-between sticky top-0 z-[1000] max-[640px]:px-5">
      <Link href="/" className="font-display text-[26px] font-black text-boza-black no-underline tracking-[-0.5px]">
        BOZA
      </Link>
      <Link href="/panier" aria-label="Panier" className="relative bg-transparent border-0 cursor-pointer text-boza-black text-lg p-[5px] inline-block">
