...
export default function EmptyCart() {
  return (
    <div className="text-center py-20 px-5">
      ...
      <Link href="/catalogue" className="inline-block py-3.5 px-8 bg-boza-black text-boza-cream border border-boza-black font-bold text-sm uppercase tracking-wide no-underline transition-all duration-300 hover:bg-boza-brown hover:border-boza-brown">
