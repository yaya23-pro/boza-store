...
export const metadata: Metadata = {
  title: "Conditions générales de vente - BOZA",
  description: "Consulte les conditions générales de vente BOZA : commande, paiement, livraison, retours et droit de rétractation.",
};
const sections = [
  {
    id: "objet",
